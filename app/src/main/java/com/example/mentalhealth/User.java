...
public class User {
    ...
    public boolean isNameEmpty() {
        return getmName().isEmpty();
    }

    public boolean isAgeEmpty() {
        return getmAge().isEmpty();
    }
    ...
    public boolean isConfPassEmpty() {
        return getmConfirmPassword().isEmpty();
    }

    public boolean isSame() {
        return getmConfirmPassword().equals(getPassword());
    }
